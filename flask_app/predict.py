...
from monoloco.activity import show_activities
...
def main():
    from monoloco.run import cli, run_prediction
    args = cli()
    
    #print(args)
    '''args.model = None
    args.calibration = 'custom'
    args.path_gt = None
    args.output_types = None

    args.long_edge = None
    args.fast_rescaling = None
    args.images = ['../docs/000840.png']
    args.json_output = None
    args.output_directory = 'output/'
    args.focal_length = 5.7
    args.activities = []
    args.z_max = 100
    args.dpi = 100
    args.webcam = None
