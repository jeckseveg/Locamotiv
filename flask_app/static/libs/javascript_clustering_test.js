...
fs.readFile(groundPointsPath, 'utf8', (err, data) => {
    ...
    G = javascript_clustering.createGraph(G, frame, maxDistance); // create base graph with initial connections
    ...
    var centroids = javascript_clustering.computeCentroids(clusters,G);
    var edges = G.edges();
    var nodeObject = {};
