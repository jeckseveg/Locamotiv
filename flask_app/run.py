...
def cli():
    ...
    parser.add_argument('--mode', help='keypoints, mono, stereo', default='mono')
    ...
    predict_parser.add_argument('-o', '--output-directory', help='Output directory',default='output_images')
    ...
    #args = parser.parse_args(namespace=args)  # Re-parse with updated namespace
    #print(args.model)
    return args
...
def main():
    ...
    if True:
        ...
        if args.webcam:
            ...
            args.images = ['input_images/test.jpeg'] # change this
            predict(args)
